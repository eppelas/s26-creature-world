...
(function (root, factory) {
  ...
  var PROJECT_QUESTIONS = [
    ...
    {
      /* Текст просим только после трёх нажатий: к этому моменту человек уже
         внутри, и одна строка не выглядит стеной. */
      key: 'about', type: 'text', trait: 'место',
      text: 'Осталось два вопроса, оба словами. Первый: над чем ты работаешь эти три недели? Хватит одной строки — «телеграм-бот для записи» или «ремонт кухни».'
    },
    {
      key: 'wish', type: 'text', trait: 'предмет',
      text: 'И последний. Что должно появиться в этом пространстве, чтобы тебе было в нём хорошо? Окно, музыка, живой человек рядом, тишина — что угодно, одним словом.'
    }
  ];
